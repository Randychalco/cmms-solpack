    ...
    sections: [
        ...
        },
        {
            ...
            rows: [
                ...
                { id: 'chill_roll', label: 'Chill Roll', rangeMotor: '25-40 °C', rangeReduc: '30-70 °C' }
            ]
        },
        {
        ...
        },
        {
            ...
            type: 'matrix_status',
            rows: [
                { id: 'estado_cr_1', label: 'Estado físico del Chill Roll 1' },
...
async function run() {
    try {
        ...
        console.error('Error insertando o actualizando SML 2 Matrix:', e.message);
    }
}
run();
