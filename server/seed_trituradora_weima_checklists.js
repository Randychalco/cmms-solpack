...
async function seedTrituradoraWeimaChecklists() {
    try {
        console.log('Seeding Trituradora Weima Checklist...');
            ...
            sections: [
                ...
                },
                {
                    ...
                    rows: [
                        ...
                        { id: 'p7', label: 'Verificar nivel de aceite bomba de sistema hidraulico', param: 'Nivel', metodo: 'Inspección visual' },
                        { id: 'p8', label: 'Verificar sistema de empuje hidráulico (Grupo hidraulico)', param: 'Presión', metodo: 'Observación' },
                        { id: 'p9', label: 'Verificar fugas en mangueras hidraulicas', param: 'Hermeticidad', metodo: 'Inspección visual' },
                ...
                },
                {
                    ...
                    rows: [
                        ...
                        { id: 't3', label: 'Bomba Hidraulica', nominal_val: '50-70°c' }
                    ]
                }
            ]
        };

        const templateName = 'RUTINA DE INSPECCION GENERAL - Trituradora Weima';
        ...
        if (existing.rows.length > 0) {
            ...
            await db.query(`
                ...
                SET items = $1, layout = 'sml2_matrix', asset_category = 'BEIER_TRITURADORA'
                WHERE name = $2
            ...
            await db.query(`
                ...
                VALUES ($1, $2, $3, $4)
            `, [templateName, 'BEIER_TRITURADORA', 'sml2_matrix', JSON.stringify(checklistItems)]);
        }

        console.log('\nSuccessfully seeded TRITURADORA WEIMA checklist.');
        process.exit(0);
...
seedTrituradoraWeimaChecklists();
